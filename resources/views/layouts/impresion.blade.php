...
<div class="no-imprimir sticky top-0 z-10 border-b border-slate-200 bg-white/95 backdrop-blur">
    <div class="mx-auto flex max-w-4xl flex-wrap items-center justify-between gap-3 px-4 py-3">
        <div class="min-w-0">
            @yield('barra-titulo')
        </div>
        <div class="flex flex-wrap items-center gap-2">
            @yield('barra-acciones')
...
<main class="mx-auto max-w-4xl px-3 py-6 print:m-0 print:max-w-none print:p-0">
    @yield('contenido')
</main>
